...
from sqlalchemy import Integer, String, Float, Text, DateTime, Boolean, ForeignKey, func, LargeBinary
...
class Product(Base):
    ...
    product_image: Mapped[bytes] = mapped_column(LargeBinary)  # Изменяем тип на LargeBinary
